          ...
          <div className="flex justify-center px-10">
            <div className="relative overflow-hidden rounded-lg shadow-xl bg-gradient-to-r from-green">
              ...
              <div className="absolute bottom-36 right-32 text-white">
                <button type="button" className="text-white bg-green hover:bg-green focus:ring-4 focus:outline-none focus:ring-green font-bold rounded-lg text-sm px-7 py-4 text-center mr-3 md:mr-0 dark:bg-green dark:hover:bg-green dark:focus:ring-green">Mulai Bertanya</button>
              </div>
            </div>
          </div>
        </div>
